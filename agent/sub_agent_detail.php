...
<body>
	...
	<div class="stat-card">
		...
		<table class="info-table">
			<tr>
				<td>代理ID</td>
				<td><?php echo $subAgent['id']; ?></td>
			</tr>
			<tr>
				<td>代理账号</td>
				<td><?php echo $subAgent['username']; ?></td>
			</tr>
			<tr>
				<td>代理名称</td>
				<td><?php echo $subAgent['name']; ?></td>
			</tr>
			<tr>
				<td>账户余额</td>
				<td><span style="color: #ff5722; font-size: 18px; font-weight: bold;">¥<?php echo number_format($subAgent['balance'], 2); ?></span></td>
			</tr>
			<tr>
				<td>代理级别</td>
				<td>Level <?php echo $subAgent['level']; ?></td>
			</tr>
			<tr>
				<td>上级代理</td>
				<td><?php echo $agentInfo['name']; ?> (ID: <?php echo $agentInfo['id']; ?>)</td>
			</tr>
			<tr>
				<td>账号状态</td>
				<td>
					<?php if ($subAgent['state'] == 1): ?>
			...
			<tr>
				<td>创建时间</td>
				<td><?php echo $subAgent['created_time']; ?></td>
			</tr>
			<tr>
				<td>最后登录</td>
				<td><?php echo $subAgent['last_login'] ?: '从未登录'; ?></td>
			</tr>
		</table>
	</div>
	...
	<div class="stat-card">
		...
		<div class="layui-row layui-col-space15">
			...
			<div class="layui-col-md3">
				<div class="stat-item">
					<div class="stat-value" style="color: #ff5722;"><?php echo number_format($subAgent['balance'], 2); ?></div>
	...
	<script>
		layui.use(['table', 'layer'], function() {
			...
			table.render({
				elem: '#kami_list',
				url: 'ajax.php?act=getsubagentkami&agent_id=<?php echo $id; ?>',
				page: true,
				limit: 20,
				limits: [20, 50, 100],
				cols: [[
