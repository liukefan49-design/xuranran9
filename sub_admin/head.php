					...
					<ul id="Nav" class="layui-nav layui-nav-tree" lay-filter="tabnav">
						<li class="layui-nav-item layui-nav-itemed">
							...
							<dl class="layui-nav-child">
								...
								<?php if ($subconf['qx'] == 0): ?>
								<dd><a href="admin_list.php"><span>管理员管理</span></a></dd>
								<?php endif; ?>
							</dl>
						</li>
						<li class="layui-nav-item layui-nav-itemed">
						...
						<li class="layui-nav-item layui-nav-itemed">
							...
							<dl class="layui-nav-child">
								<dd><a href="agent_list.php"><span>代理列表</span></a></dd>
								<dd><a href="agent_level.php"><span>代理等级</span></a></dd>
								<dd><a href="agent_register_audit.php"><span>注册审核</span></a></dd>
								<dd><a href="balance_recharge.php"><span>余额充值</span></a></dd>
							</dl>
						</li>
						<li class="layui-nav-item layui-nav-itemed">
							<a href="javascript:;">
							...
							<dl class="layui-nav-child">
								...
								<dd><a href="kami_price.php"><span>卡密价格</span></a></dd>
							</dl>
						</li>
						<li class="layui-nav-item layui-nav-itemed">
							<a href="javascript:;">
							...
							<dl class="layui-nav-child">
								<dd><a href="agent_notice.php"><span>公告管理</span></a></dd>
							</dl>
						</li>
						<li class="layui-nav-item layui-nav-itemed">
							<a href="javascript:;">
